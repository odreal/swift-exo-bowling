...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="bowling",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC7bowling11AppDelegate")
...
SWIFT_CLASS("_TtC7bowling26GroundNormalViewController")
@interface GroundNormalViewController : UIViewController
- (void)viewDidLoad;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified debugLabel;
...
SWIFT_CLASS("_TtC7bowling8PlayArea")
@interface PlayArea : UIView
...
SWIFT_CLASS("_TtC7bowling13SceneDelegate")
...
SWIFT_CLASS("_TtC7bowling14ViewController")
@interface ViewController : UIViewController
- (void)viewDidLoad;
- (IBAction)PlayButton:(id _Nonnull)sender;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
